...
<body>
        ...
        <form action="bike_transaction.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="product" name="product" required onchange="showProductImage()">
                    ...
                    <option value="Fixedgear vs Everybody">Fixedgear vs Everybody</option>
                    <option value="Live Fast, Die Last">Live Fast, Die Last</option>
                    <option value="Rekta Silangan">Rekta Silangan</option>
                    <option value="FXD Clothing">FXD Clothing</option>
                </select>
            </div>
            <div class="form-group">
    ...
    <script>
        function showProductImage() {
            ...
            const productImages = {
                "Fixedgear vs Everybody": "pic/f1.jpg",
                "Live Fast, Die Last": "pic/f2.jpg",
                "Rekta Silangan": "pic/f3.jpg",
                "FXD Clothing": "pic/f4.jpg"
            };
